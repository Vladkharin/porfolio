          ...
          <AboutContent>
            <AboutLeftSide>
              ...
              <AboutP $lightTheme={lightTheme}>
                Я начинающий Frontend-разработчик. Занимаюсь web-разработкой 5 года. Есть коммерческий опыт 1 год и два месяца. Амбициозный,
                целеустремленный и коммуникабельный. Всегда нахожу общий язык с людьми. Стараюсь развиваться и никогда не стою на месте.
                Очень хочется поработать с людьми в команде. . Активно ищу работу. Хочу найти своё место в компание, которая нуждается во
                мне. Знаю, что сейчас бешеная конкуренция, я готов доказывать.
              </AboutP>
            </AboutLeftSide>
            <AboutRightSide>
